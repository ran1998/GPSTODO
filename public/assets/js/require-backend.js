require.config({
    ...
    paths: {
        ...
        'zTree': '../libs/zTree/js/jquery.ztree.core.min',
        'zTreeCheck': '../libs/zTree/js/jquery.ztree.excheck.min',
...
//            'css!../libs/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
        ...
        'bootstrap-slider': ['css!../libs/bootstrap-slider/dist/css/bootstrap-slider.min.css'],
//        'bootstrap-select': ['css!../libs/bootstrap-select/dist/css/bootstrap-select.min.css',],
        'bootstrap-select-lang': ['bootstrap-select'],
//        'toastr': ['css!../libs/toastr/toastr.min.css'],
        'jstree': ['css!../libs/jstree/dist/themes/default/style.css',],
        'zTree': ['css!../libs/zTree/css/zTreeStyle/zTreeStyle.css',],
        'plupload': {
